  ...
  return (
    ...
    >
      <motion.div
        ...
        className="z-10 w-5 h-5 rounded-full bg-white dark:bg-red-600 shadow-lg flex items-center justify-center"
      >
        <AnimatePresence mode="wait">
          {isDark ? (
            ...
            <motion.div
              ...
              transition={{ duration: 0.2 }}
            >
              <Sun className="w-3 h-3 text-red-600 fill-current" />
            </motion.div>
          )}
        </AnimatePresence>
      </motion.div>
